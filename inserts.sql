...
BEGIN TRY
    BEGIN TRANSACTION 
	   ...
	   insert into Vendas (fid,pid,preco_venda) values (1,1,2.2)
	   insert into Vendas (fid,pid,preco_venda) values (1,1,2.2)
	   insert into Vendas (fid,pid,preco_venda) values (1,1,2.2)
	   insert into Vendas (fid,pid,preco_venda) values (1,2,3)
	   insert into Vendas (fid,pid,preco_venda) values (2,3,1.5)
	   insert into Vendas (fid,pid,preco_venda) values (2,3,1.5)
	   insert into Vendas (fid,pid,preco_venda) values (2,4,1)
